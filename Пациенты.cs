...
namespace lab
{
    ...
    {
        int r = 0, s, p; // s - сортировка, а p - это фильтр
        ...
        {
            string SqlText = null;
            if (MyClass.dolgnost == "lab") //для лаборанта
            {
                if (p == 0)
                {
                    if (s == 0)
            ...
            else if (MyClass.dolgnost == "admin") //для администратора
            {
                if (p == 0)
                {
                    if (s == 0)
